...
// Same wording, different formatting: plain text here, `strong()` (bold)
// in the other version. This is a *pure* style change with no text
// change -- see the "Known limitations" section of the README for how
// the diff tool handles this case.
#let status = "On track"
Status: #status

#text(fill: red, weight: "bold", style: "italic")[Confidential — internal use only]
